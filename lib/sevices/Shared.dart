...
class SharedPrefs {
  Future<void> saveUserData(user, name, currentItemSelected, birthdate, education, numOfReading, numOfParts, jobTitle, photoUrl, aboutMe, gender, igaza, university) async {
    ...
    print(user.email);
    prefs.setString('photourl', user.photoUrl == null ? photoUrl == null ? null : photoUrl : user.photoUrl);
